...
<head>
    ...
    <title>SL2INDUSTRY | Meetups</title>
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="gallery.jsp">Job Opportunities</a></li>
                            <li><a href="meetup.jsp">Meetups</a></li>
                        </ul>
                    </li>
                    <li><a href="blog-archive.jsp">Our Blog</a></li>
                    <li><a href="forum.jsp">Forum</a></li>
                    <li><a href="contact.jsp">Contact</a></li>

                    <li><a href="#" id="mu-search-icon"><i class="fa fa-search"></i></a></li>
                    <li><a id="popup" onclick="div_show()" href="signin.jsp"  onmouseover="this.style.color='#f44242'" onmouseout="this.style.color='#333333'" >Sign in</a></li>
                    <li><a id="popup" onclick="div_show()" href="register.jsp"  onmouseover="this.style.color='#f44242'" onmouseout="this.style.color='#333333'" >Register</a></li>
                </ul>
            </div><!--/.nav-collapse -->
        </div>
    </nav>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mu-gallery-area">
                    <!-- start title -->
                    <div class="mu-title">
                        <h2>GET TOGETHER WITH PROFESSIONALS</h2>
                    ...
                    <div class="mu-gallery-content">
                        ...
                        <div class="mu-gallery-top">
                            <ul>
                                ...
                                <li class="filter" data-filter=".lab">Meeups</li>
                                <li class="filter" data-filter=".classroom">Conferences</li>
                                <li class="filter" data-filter=".library">Get Togethers</li>
                                <li class="filter" data-filter=".cafe">Social Events</li>
                                <li class="filter" data-filter=".others">Volunteering Opportunities</li>
                            </ul>
                        </div>
                        <!-- End gallery menu -->
