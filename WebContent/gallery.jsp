...
<html lang="en">
  <head>
    ...
    <title>SL2INDUSTRY | Job Opportunities</title>
          ...
          <div class="mu-gallery-content">
            ...
            <div class="mu-gallery-top">              
              <ul>
                ...
                <li class="filter" data-filter=".lab">Internships</li>
                <li class="filter" data-filter=".classroom">Marketing</li>
                  <li class="filter" data-filter=".library">Developer Engineers</li>
                <li class="filter" data-filter=".cafe">UI/UX Engineers</li>
                <li class="filter" data-filter=".others">QA Engineers</li>
              </ul>
            </div>
            <!-- End gallery menu -->
