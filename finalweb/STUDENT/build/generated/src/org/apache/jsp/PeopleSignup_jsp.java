...
public final class PeopleSignup_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("                if (document.getElementById(\"email\").value.length == 0) {\n");
      out.write("                    swal(\"Please Type Your Email..!\", null, \"error\");\n");
      out.write("                    return false;\n");
      out.write("                }\n");
      out.write("\n");
      out.write("                if (document.getElementById(\"pw1\").value != document.getElementById(\"pw2\").value) {\n");
      out.write("                    swal(\"Password does not match..!\", null, \"error\");\n");
      out.write("                    return false;\n");
      out.write("                }\n");
      out.write("\n");
      out.write("            }\n");
      ...
      out.write("                        <h2 class=\"section-heading\">Create Industry People Account</h2>\n");
      ...
      out.write("                        <form action=\"Servsign2\" method=\"POST\" name=\"signup\" onsubmit=\"return validate();\"> \n");
      ...
      out.write("                            <input type=\"text\" id=\"City\" class=\"form-control\" name=\"add\" placeholder=\"Address\" required=\"\"/><br>\n");
      out.write("                            <input type=\"text\" id=\"City\" class=\"form-control\" name=\"emp\" placeholder=\"Employee No\" required=\"\"/><br>\n");
      out.write("                            <input type=\"text\" id=\"Street\" class=\"form-control\" name=\"com\" placeholder=\"Company Name\" required=\"\"/><br>\n");
      out.write("                            <input type=\"text\" id=\"Cno\" class=\"form-control\" name=\"cno\" placeholder=\"Contact Number\" required=\"\"/><br>\n");
      out.write("                            <input type=\"text\" id=\"fac\" class=\"form-control\" name=\"dep\" placeholder=\"Department\" required=\"\"/><br>\n");
 ...
 if (String.valueOf(request.getAttribute("error")).equals("error")) { 
      out.write("\n");
      out.write("                    <script> swal(\"Error in Signup!\", null, \"error\");</script>\n");
      out.write("                    ");
 }
      out.write("\n");
      out.write("                    ");
 if (String.valueOf(request.getAttribute("error")).equals("exists")) { 
      out.write("\n");
      out.write("                    <script> swal(\"Email Already Exists!\", null, \"error\");</script>\n");
      out.write("                    ");
 }
      out.write("\n");
      out.write("                </div>\n");
